...
import type { AgentState } from "~/ecosystem/agent/AgentState";
import type { Sandbox } from "~/ecosystem/container/sandbox";
...
import type {
  ...
  ToolCallEvent,
  ToolResultEvent,
} from "~/ecosystem/agent/event/stream";
...
} from "~/ecosystem/agent/event/message";

// Error Layer Events (independent, transportable via SSE)
import type { ErrorEvent } from "~/ecosystem/agent/event/error";

// Turn Layer Events
import type { TurnRequestEvent, TurnResponseEvent } from "~/ecosystem/agent/event/turn";
