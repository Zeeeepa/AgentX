/**
 * Ecosystem - Node.js Ecosystem implementation
 *
 * Assembles all ecosystem components for running AI Agents:
 *
...
import { AgentInstance, MemoryContainer, generateAgentId, createAgentContext } from "@agentxjs/agent";
...
const logger = createLogger("ecosystem/Ecosystem");
...
/**
 * Ecosystem - Assembled ecosystem for Node.js platform
 */
export class Ecosystem {
  ...
  dispose(): void {
    ...
    logger.info("Ecosystem disposed");
  }
...
/**
 * Create an Ecosystem with optional configuration
 *
 * @example
 * ```typescript
 ...
 * ```
 */
export function createEcosystem(config?: EcosystemConfig): Ecosystem {
  return new Ecosystem(config);
}
